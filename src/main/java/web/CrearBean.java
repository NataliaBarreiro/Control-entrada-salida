...
@ManagedBean
@SessionScoped
public class CrearBean implements Serializable{
    ...
    public void guardar(){
        ...
        System.out.println("- El numero de identificacion ingresado: "+id);
        System.out.println("- La edad ingresada: "+edad);
        System.out.println("- El cargo ingresado: "+cargo);
        System.out.println("- La fecha de vinculacion ingresada: "+fechaVinculacion);
